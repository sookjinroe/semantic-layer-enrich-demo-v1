...
(function() {
  ...
  const FINERACT_TABLE_ORDER = ["glim_accounts", "gsim_accounts", "m_loan", "m_loan_amortization_allocation_mapping", "m_loan_charge", "m_loan_credit_allocation_rule", "m_loan_payment_allocation_rule", "m_loan_reage_parameter", "m_loan_reamortization_parameter", "m_loan_recalculation_details", "m_loan_reschedule_request", "m_loan_status_change_history", "m_loan_term_variations", "m_loan_transaction", "m_loan_transaction_relation", "m_client", "m_client_identifier", "m_deposit_account_interest_incentives", "m_deposit_account_on_hold_transaction", "m_deposit_account_term_and_preclosure", "m_savings_account", "m_savings_account_charge", "m_savings_account_transaction", "m_savings_product"];
