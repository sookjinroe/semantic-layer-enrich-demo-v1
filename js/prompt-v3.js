...
- codedict : categorical_dimension 의 값→라벨. [{value,label},...]. 연결이 확인된 매핑만. NL 은 이 표로 자연어를 코드로 바꾸고, 검수자는 이 라벨이 업무 용어와 맞는지 본다. 권위를 못 찾았으면 빈 배열이 정답이고, 그 사실을 review_note 로 넘긴다.
...
{"action":"answer","description":"...","capability":{"primary":"categorical_dimension","alternatives":[]},"codedict":[],"format":null,"aggregation":{"additive":null,"suggested":[]},"confidence":"MEDIUM","review_note":"코드값 01~04의 의미를 확인할 정의가 시스템 어디에도 없음. 채널 관리 담당자에게 각 값의 의미 확인 필요.","needs_review":true,"thinking":"..."}
answer 예시 (권위가 확인된 깨끗한 경우):
{"action":"answer","description":"...","capability":{"primary":"categorical_dimension","alternatives":[]},"codedict":[{"value":"01","label":"원금균등상환"},{"value":"02","label":"원리금균등상환"},{"value":"03","label":"만기일시상환"}],"format":null,"aggregation":{"additive":null,"suggested":[]},"confidence":"HIGH","review_note":"","needs_review":false,"thinking":"..."}
