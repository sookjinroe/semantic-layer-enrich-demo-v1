...
function RenderScreen() {
  ...
  const RERUN_SETS = {
    ...
    // 2026-07-13: JPA @Embedded 전개로 신규 편입된 110컬럼 (미증강 - 첫 실행 필요).
    // 원천: cbse slice/columns_delta_20260713.jsonl. 실행 완료·병합 후 이 목록은 비울 것.
    fineract: [],  // 2026-07-13 @Embedded 신규 110 실행·병합 완료 (구출 스냅샷 render-snapshot-rescued 경유)
  };
