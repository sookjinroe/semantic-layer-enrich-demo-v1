...
[좋은 Description]
- 소비자(NL)는 이미 컬럼의 이름·타입을 본다. 이름을 바꿔 말하면 가치 0.
- 가치 = 이름+타입 *너머로*, NL 이 그것 없이는 못 하던 행동을 하게 하는 정보(값공간의 모양·형식·유사 컬럼과의 구분·계보·주의).
- 이름은 *저신뢰 신호*다(암호적·비표준·오도 가능). 다른 신호로 교차검증하고, 어긋나면 교정하라("이름은 X 시사하나 실제 Y").
...
answer: {"action":"answer","description":"한~세 문장","confidence":"HIGH|MEDIUM|LOW","evidence":["쓴 신호+출처 예: orm, profile, code:LoanApplicationService.java"],"conflicts":[{"type":"…","detail":"…"}],"route_to_human":{"needed":false,"reason":""},"thinking":"1문장"}
